...
![Image of Set feature layer rendering mode on map sample](set-feature-layer-rendering-mode-on-map.png)
...
1. Create a map with operational layers and set the `renderingMode` for each layer.
