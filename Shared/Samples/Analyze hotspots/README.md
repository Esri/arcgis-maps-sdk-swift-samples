...
Select a date range (between 1998-01-01 and 1998-05-31) from the dialog and select Analyze. The results will be shown on the map upon successful completion of the geoprocessing job.
