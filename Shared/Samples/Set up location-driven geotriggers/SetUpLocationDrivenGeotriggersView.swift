...
private extension SetUpLocationDrivenGeotriggersView {
    ...
    class Model: ObservableObject {
        ...
        init() {
            ...
            locationDataSource = SimulatedLocationDataSource(polyline: .walkingTour)
        ...
        /// Creates a location display from the location data source.
...
private extension Polyline {
    ...
    static var walkingTour: Polyline {
