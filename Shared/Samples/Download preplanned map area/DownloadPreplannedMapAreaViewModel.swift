...
@MainActor
class DownloadPreplannedMapAreaViewModel: ObservableObject {
    ...
    private func selectedMapDidChange() async {
        switch selectedMap {
        case .onlineWebMap: offlineMap = nil
        case .preplannedMap(let preplannedMapArea):
...
extension DownloadPreplannedMapAreaViewModel {
    enum SelectedMap: Hashable {
        static func == (lhs: DownloadPreplannedMapAreaViewModel.SelectedMap, rhs: DownloadPreplannedMapAreaViewModel.SelectedMap) -> Bool {
            switch (lhs, rhs) {
