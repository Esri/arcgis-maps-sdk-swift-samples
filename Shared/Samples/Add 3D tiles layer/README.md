...
A layer to visualize 3D tiles data that conforms to the OGC 3D Tiles specification. As of ArcGIS Maps SDK for Swift 200.4, it supports analyses like exploratory viewshed and exploratory line of sight, but does not support other operations like individual feature identification.
