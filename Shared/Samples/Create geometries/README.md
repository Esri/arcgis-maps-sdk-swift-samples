...
![Image of Create geometries sample](create-geometries.png)
...
1. Use the initializers for the various simple `Geometry` types including `Point`, `Polyline`, `Multipoint`, `Polygon`, and `Envelope`.
