...
![Image of identify layer features](identify-layer-features.pngs)
...
Tap to identify features. An alert will show all layers with features under the tapped location, as well as a layer count.
