...
Specify a minimum population in the text field (values under 1810000 will produce a selection in all layers), and after a short time, the results for each sublayer will appear as graphics.
